...
\subsection{Greenfilling: Suppressing Backfill Starts on a Relative Signal}
...
Mustang & slack & water & $-0.031\%$ & $0.000\%$ & $+308.5\%$ \\
Mustang & stress & carbon & $+0.008\%$ & $+0.043\%$ & $+175.0\%$ \\
Mustang & stress & water & $+0.014\%$ & $+0.044\%$ & $+161.5\%$ \\
Trinity & slack & carbon & $-0.005\%$ & $0.000\%$ & $+210.1\%$ \\
Trinity & slack & water & $-0.007\%$ & $0.000\%$ & $+211.5\%$ \\
Trinity & stress & carbon & $+0.001\%$ & $0.000\%$ & $+226.6\%$ \\
Trinity & stress & water & $-0.000\%$ & $0.000\%$ & $+213.3\%$ \\
\bottomrule
\end{tabular}
\end{table}
...
\subsection{Job Shifting: Pricing Each Start in Absolute Terms}
...
The bound is not small, as \Cref{fig:shifting-ceiling-horizon} shows. The aggregate ceiling grows with the allowed displacement and reaches 6.76\% for carbon and 4.89\% for water at a $d_m$ of 24 hours, almost two orders of magnitude above the sub-0.1\% medians of the Greenfilling campaign. Water pays off less than carbon over the whole horizon, consistent with the flatter daily profile of the water signals: averaged over the 12 windows per country used in the Greenfilling campaign, mean swing is 0.50 for carbon against 0.47 for water in Germany, 0.32 against 0.29 in France, and 0.24 against 0.23 in Poland (\Cref{tab:shifting-swing}), a gap that holds across all three grids.
...
\begin{table}
\centering
\caption{Mean swing of the carbon and water signals by grid, averaged over the 12 windows per country used in the Greenfilling campaign.}
\label{tab:shifting-swing}
\begin{tabular}{lrr}
\toprule
Grid & Swing, carbon & Swing, water \\
\midrule
Germany & 0.50 & 0.47 \\
France & 0.32 & 0.29 \\
Poland & 0.24 & 0.23 \\
