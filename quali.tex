...
% Igual a \citeauthor, mas o nome do autor vira um link para a bibliografia.
% \citeauthor não passa pelas macros corrigidas em plainnat-ime.cbx, porque
% imprime \printnames diretamente, sem o wrapper bibhyperref.
\DeclareCiteCommand{\citeauthorlink}
...
% armazenados nos metadados do PDF. O subtítulo é opcional. O título é dado
% na língua principal do documento. Por exemplo, se seu trabalho está escrito
% em português, essa é a língua do título e "translatedtitle" se refere ao
% título em inglês; se seu trabalho está escrito em inglês, essa é a língua
% do título e "translatedtitle" se refere ao título em português.
\title{Accounting for the Full Environmental Cost of High-Performance Computing}[From Operational Scheduling to Lifecycle Sufficiency]
\translatedtitle{Contabilizando o custo ambiental completo da computação de alto desempenho}[Do escalonamento operacional à suficiência no ciclo de vida]

\author[mas]{Lucas de Sousa Rosa}

\def\profa{Prof\kern.02em.\kern-.07emª\kern.07em}
\def\dra{Dr\kern-.04em.\kern-.11emª\kern.07em}

% Para TCCs, este comando define o supervisor
\orientador[mas]{Prof. Dr. Alfredo Goldman}
...
%
\apoio{During the development of this work, the author received\\ financial support from FAPESP under grant \#2023/09048-8.\\ This study was also financed in part by the Coordenação de\\ Aperfeiçoamento de Pessoal de Nível Superior -- Brasil\\ (CAPES) -- Finance Code 001.}
...
% \noindent Para gerar a ficha catalográfica, acesse \url{https://fc.ime.usp.br},
%           preencha o formulário e escolha a opção ``Gerar Código \LaTeX''.
%           Basta copiar e colar o resultado dentro do comando \Verb
%           |\fichacatalografica| (substituindo este texto explicativo).
...
\input{content/01-what-the-field-measures}
\input{content/02-preliminary-results}
\input{content/03-research-plan}
\input{content/04-schedule-and-contributions}
